  ...
  Widget build(BuildContext context) {
    return Obx((){
      return  GridView.builder(
          ...
          padding: EdgeInsets.only( top:AppDimensions.spacing_15,left: AppDimensions.spacing_15,right: AppDimensions.spacing_15,bottom: 15),
          shrinkWrap: true,
            ...
            return Container(
              ...
              child: Column(
                ...
                children: [
                  InkWell(
                    onTap: (){
                      Get.to(ImageViewWidget(image: controller.images[index]));
                    },
                    child: Container(
                      height:150,
